...
TRACE_FIELDS = ("first_name", "lead_name", "last_name", "mobile_no", "phone", "email", "status", "source", "campaign_name", "visa_type", "custom_visa_type", "destination", "custom_destination", "budget", "custom_budget", "custom_travel_month", "custom_passport_status", "country", "country_interested", "meta_raw_fields")
