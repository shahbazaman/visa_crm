...
def _lead_values(data, meta_fields, name, source):
    ...
    return {"lead_name": name, "first_name": first_name, "last_name": data.get("last_name") or meta_fields.get("last_name"), "customer_name": name, "organization": name, "mobile_no": phone, "phone": phone, "phone_number": phone, "email": email, "email_id": email, "city": data.get("city") or meta_fields.get("city"), "country": country, "country_interested": country, "country_of_interest": country, "visa_type": visa_type, "custom_visa_type": visa_type, "budget": data.get("budget"), "custom_budget": data.get("custom_budget") or data.get("budget"), "travel_date": data.get("travel_date"), "travel_month": data.get("travel_month"), "custom_travel_month": data.get("custom_travel_month") or data.get("travel_month"), "destination": data.get("destination"), "custom_destination": data.get("custom_destination") or data.get("destination"), "passport": data.get("passport"), "custom_passport_status": data.get("custom_passport_status") or data.get("passport"), "message": data.get("message"), "notes": notes, "meta_raw_fields": data.get("meta_raw_fields"), "source": source, "lead_source": source, "status": "Open", "workflow_state": "Lead", "campaign_name": data.get("campaign_name"), "ad_name": data.get("ad_name"), "facebook_lead_id": data.get("source_lead_id"), "facebook_form_id": data.get("form_id"), "facebook_page_id": data.get("page_id"), "meta_campaign_id": data.get("campaign_id"), "meta_campaign_name": data.get("campaign_name"), "meta_adset_id": data.get("adset_id"), "meta_adset_name": data.get("adset_name"), "meta_ad_id": data.get("ad_id"), "meta_ad_name": data.get("ad_name")}
